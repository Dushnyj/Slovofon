...
### Fixed
- Растровые тесты иконок перемотки используют один шрифт из Flutter SDK на Windows и Linux: отсутствие Segoe UI на GitHub runner больше не подменяет цифры тестовыми блоками и не вызывает ложные ошибки направления стрелок.
