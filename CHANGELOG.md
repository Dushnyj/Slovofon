...
Версия исходников подготовлена; публикация и готовые файлы отмечаются отдельно в GitHub Releases.
...
### Changed
- Версия исходников и приложения синхронно повышена до `0.0.7+7`; release-сборка и публикация этим изменением не выполняются.
