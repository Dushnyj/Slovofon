...
### Changed
- README сокращён и переоформлен: единая шапка с крупными значками релиза и платформ, быстрый выбор установщика, галерея и блоки Note / Tip / Important / Caution. Удалены дубли версий, статус сборки и устаревшие служебные пояснения; в руководстве пользователя уточнены ручной переход с v0.0.6 и обновление Android APK по архитектуре.
