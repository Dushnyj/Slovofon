...
### Fixed
- Исправлено закрытие Windows через крестик и Alt+F4: приложение дожидается сохранения позиции и освобождения нативного плеера до завершения процесса. Ошибка сохранения отменяет закрытие и позволяет повторить.
