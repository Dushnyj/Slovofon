...
Windows mini-player                     — отдельная компактная оболочка над AudioService
```
...
- AudioService зависит от конкретного экрана;
